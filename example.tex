...
\begin{homeworkProblem}{Give an appropriate positive constant \(c\) such that \(f(n) \leq c \cdot
    g(n)\) for all \(n > 1\).}
...
\begin{homeworkProblem}{Write part of \alg{Quick-Sort($list, start, end$)}}
    \begin{algorithm}[]
        \begin{algorithmic}[1]
